...
_G.packer_plugins = {
  LuaSnip = {
    loaded = true,
    path = "/home/jeff/.local/share/nvim/site/pack/packer/start/LuaSnip",
  ...
  cmp_luasnip = {
    loaded = true,
    path = "/home/jeff/.local/share/nvim/site/pack/packer/start/cmp_luasnip",
  ...
  ["gruvbox.nvim"] = {
    loaded = true,
    path = "/home/jeff/.local/share/nvim/site/pack/packer/start/gruvbox.nvim",
    url = "https://github.com/ellisonleao/gruvbox.nvim"
  },
  ["lsp-zero.nvim"] = {
    loaded = true,
    path = "/home/jeff/.local/share/nvim/site/pack/packer/start/lsp-zero.nvim",
  ...
  ["zk-nvim"] = {
    loaded = true,
    path = "/home/jeff/.local/share/nvim/site/pack/packer/start/zk-nvim",
